...
def run_hmmer(seq_type=None, tmp_hmmer=None, input_eval=None, tmp_fasta=None, threads=4):
    ...
    parse_cmd = f"python bin/hmm.py --hmmer_output_file {tmp_hmmer} --parsed {tmp_hmmer_parsed}"
