            ...
            dmc.SimpleGrid([
                ...
                dmc.Stack([
                    ...
                    dmc.Divider(my="sm"),
                        ...
                        ], gap="md", grow=True, align="center"),
                ], gap="xl", justify="center", style={"height": "100%"}),
