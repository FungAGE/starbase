#' @rdname int_heat_tree
#' @export

int_heat_tree <- function(...) {
  UseMethod("int_heat_tree")
}

#' @param .input An object of type \code{\link{taxmap}}
#' 
#' @method int_heat_tree Taxmap
#' @export
#' @rdname int_heat_tree

require(metacoder)

int_heat_tree.Taxmap <- function(.input, ...) {
  ...
  # Call heat_tree
  do.call(int_heat_tree, arguments)
}

int_heat_tree.default <- function(taxon_id, supertaxon_id, 
                              node_label = NA,
                              edge_label = NA,
                              tree_label = NA,
