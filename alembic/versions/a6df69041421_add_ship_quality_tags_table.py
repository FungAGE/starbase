...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['joined_ship_id'], ['joined_ships.id'], ondelete='CASCADE'),
        sa.UniqueConstraint('joined_ship_id', 'tag_type', name='uq_ship_quality_tags_ship_tag')
    )
    
    # Create indexes for efficient querying
    op.create_index('idx_ship_quality_tags_joined_ship_id', 'ship_quality_tags', ['joined_ship_id'])
