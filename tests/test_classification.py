...
def test_check_similar_match(mock_calc_sim, mock_ships_df, mock_similar_sequence, mock_similarities):
...
@patch('src.utils.classification.calculate_similarities')
def test_assign_accession_similar_match(mock_calc_sim, mock_ships_df, mock_similar_sequence):
    """Test full workflow with similar match."""
    mock_calc_sim.return_value = {
        'query_sequence': {'SBS000003': 0.85}
    }
