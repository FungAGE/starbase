...
def test_create_modal_ship_accession(test_ship_accession_modal_data):
    ...
    modal_content, modal_title = create_modal(test_ship_accession_modal_data, mode="ship_accession")
...
def test_create_modal_accession(test_accession_modal_data):
    ...
    modal_content, modal_title = create_modal(test_accession_modal_data, mode="accession")
