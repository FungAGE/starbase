      ...
      function (e, l, t) {
        ;(function (e) {
          ...
          var a = function (e, t, n) {
            "function" != typeof e && ((n = t), (t = e), (e = Object)),
              (t = t || {})
            var l = { name: (n = n || {}).name, base: e, implements: [] },
              i = a.clone(t)
            n.implements &&
              (Array.isArray(n.implements)
                ? n.implements
                : [n.implements]
              ).forEach(function (e) {
                "function" == typeof e &&
                  e.prototype &&
                  (l.implements.push(e), a.extend(i, e.prototype))
              }),
            ...
            return (
              ...
              Object.defineProperty(r, ".class.meta", {
                value: l,
                enumerable: !1,
                configurable: !1,
                writable: !1,
      ...
      function (r, e, t) {
        ...
        e.exports = n({
          constructor: function (e) {
            ...
            var n =
                "table tbody tr td button:hover{ text-decoration: underline;}",
            ...
            if (
              ...
              var i = {
                target: {
                  files: [new Blob([t.opt.string], { type: "text/plain" })],
                },
              }
          ...
          _displayAlignments: function (e, o) {
                ...
                ;(n.onload = function (e) {
                  try {
                    ...
                    for (
                      ...
                      for (
                        var s = document.getElementById(r[a]);
                        s.firstChild;
              ...
              return e.split("\n")[2].startsWith("<BlastOutput>")
                      ...
                      if (t[l].startsWith("<Hit>")) {
                        ...
                        for (
                          ...
                          if (
                            ...
                            var v = "N/A",
                              b =
                                (c[u].split("<Hsp_gaps>")[1].split("</")[0] /
                                  g) *
                                100
                          else {
                            var C = c[u]
                              .split("<Hsp_positive>")[1]
                              .split("</")[0]
                            ;(v = parseFloat((C / g) * 100).toFixed(0)),
                              (b =
                                (c[u].split("<Hsp_gaps>")[1].split("</")[0] /
                                  g) *
                                100)
                        ...
                        for (
                          var I = parseFloat(p[0].score), B = 1;
                          B < p.length;
                          B++
                        )
                          I += parseFloat(p[B].score)
                ...
                : (function (e) {
                    for (
                      ...
                      if (t[l].startsWith(">")) {
                        for (
                          var i = t[l].split(">")[1], r = "", a = l;
                          "" == r;

                        )
                          t[(a += 1)].startsWith("Length=")
                            ? (r = t[a])
                            : (i += t[a])
                        var s = i,
                          o = r.split("=")[1],
                        ...
                        do {
                          ...
                          var c = t[a + 2]
                            ...
                            m = t[a + 3]
                              ...
                              .substr(
                                0,
                                t[a + 3].split(",")[0].split("(")[1].length - 2
                              )
                          if (t[0].startsWith("BLASTN"))
                            ...
                            (h = t[a + 3]
                              ...
                              .substr(
                                0,
                                t[a + 3].split(",")[1].split("(")[1].length - 2
                              )),
                              (f = t[a + 3]
                                .split(",")[2]
                                .split("(")[1]
                                .substr(
                                  0,
                                  t[a + 3].split(",")[2].split("(")[1].length -
                                    2
                                ))
                          ;("Frame" != t[a + 4].split(",")[0].split(" ")[1] &&
                            !t[a + 4].startsWith(" Strand")) ||
                            (a += 1)
                          var g = t[a + 5]
                              .substring(5)
                              .replace(/^\s+/g, "")
                        ...
                        for (
                          var A = parseFloat(d[0].score), I = 1;
                          I < d.length;
                          I++
                        )
                          A += parseFloat(d[I].score)
            ...
            function _(e, t) {
              for (var n = 0, l = u(e), i = 0; i < l.length; i++)
                n += parseInt((100 * (l[i].end - l[i].start + 1)) / t)
              return n
            }
            function u(e) {
              for (var t = [], n = 0; n < e.length; n++)
                parseInt(e[n].queryStart) > parseInt(e[n].queryEnd)
                  ? t.push({
                      start: parseInt(e[n].queryEnd),
                      end: parseInt(e[n].queryStart),
                    })
                  : t.push({
              ...
              return (function (e) {
                for (var t = [], n = 0; n < e.length; n++) {
                  for (
                    var l = e[n][0].start, i = e[n][0].end, r = 0;
                    r < e[n].length;
                    r++
                  )
                    e[n][r].start < l && (l = e[n][r].start),
                      e[n][r].end > i && (i = e[n][r].end)
            ...
            function m(e) {
              ...
              for (t = 0; t < l.length; t++)
                (l[t].style.fontWeight = "normal"),
                  (l[t].parentElement.parentElement.style.fontWeight = "normal")
                ...
                r = (function (e, t) {
                  ...
                  for (var r = 1; r <= 5; r++) {
                    ...
                    ;(a.style.minWidth = "100px"),
                      ...
                      (a.style.float = "left"),
                      (a.innerHTML = d(t, r).bold()),
                      (a.style.backgroundColor = b(e, r)),
                      n.appendChild(a)
                  }
            ...
            function E(e, t, n) {
              ...
              for (var a = 0; a < l.length; a++) {
                ...
                if (0 == a) {
                  if (1 == l[0].start)
                    var p = parseInt(50 + (500 * (l[0].start - 1)) / n)
                  else p = parseInt(50 + (500 * l[0].start) / n)
                  var c = parseInt(550 - p - (500 * (n - l[0].end)) / n)
                } else
                  (p = parseInt((500 * (l[a].start - l[a - 1].end)) / n)),
                    (c = parseInt((500 * (l[a].end - l[a].start)) / n))
                ;(s.style.width = p + "px"),
                  ...
                  (o.onmouseout = function () {
                    document.getElementById("defline").value =
            ...
            function x(e, t, n, l, i, r, a, s) {
              ...
              if (
                ...
                var d = document.createTextNode("Change scoring to E value")
            ...
            function T(e, t, n, l, i, r, a, s) {
              ...
              if (
                ...
                var d = document.createTextNode("Change colours to grayscale")
            ...
            function h(e) {
              return e.split("\n")[2].startsWith("<BlastOutput>")
                ? (function (e) {
                    for (var t = e.split("\n"), n = 0; n < t.length; n++)
                      if (t[n].includes("<Iteration_query-def>"))
                        return t[n].split(">")[1].split("</")[0]
                  })(e)
                : (function (e) {
                    for (
                      var t = e.split("\n"), n = "", l = 0;
            ...
            function F(e, t, n, l, i, r, a) {
              ...
              ;(s.style.width = "430px"),
                ...
                (s.style.color = "#5C6D7E"),
                (s.style.float = "right")
              for (var o = 0; o < e.length; o++) {
                var d = document.createElement("option")
                ;(d.value = o),
                  (d.text = h(e[o])),
                  o == n && (d.selected = "selected"),
                  s.appendChild(d)
              }
              return (
                (s.onchange = function () {
                  !(function (e, t, n, l, i, r, a) {
                    ...
                    if (((l = k(e[n])), 0 == s.length)) {
                      for (
                        ...
                        for (
                          var p = document.getElementById(o[d]);
                          p.firstChild;
            ...
            function f(e, t, n, l, i, r, a) {
              for (
                var s = document.getElementById(a.opt.multipleAlignments);
                s.hasChildNodes();
              ...
              if (
                ...
                ;(m.style.clear = "both"),
                  (u.innerHTML = "RESULTS FOR:".bold()),
                  (u.style.marginBottom = "5px"),
                  (u.style.color = "#5C6D7E"),
                  (u.style.float = "left"),
                  o.appendChild(u),
                  o.appendChild(c),
                  o.appendChild(m)
              }
              ;(o = C(o, i, r, l)).appendChild(p),
                (s.style.minWidth = "580px"),
                o.appendChild(d),
                s.appendChild(o)
            }
            function g(e, t, n, l, i, r, a, s) {
              for (
                var o = document.getElementById(s.opt.multipleAlignments);
                o.hasChildNodes();
                ...
                (n.onclick = function () {
                  !(function (e) {
                    ...
                    i.setAttribute("href", l),
                      i.setAttribute("download", "alignments-table.csv"),
                      i.click()
                  })(e)
                }),
                (i.className = "btn"),
            ...
            function v(e, t) {
              for (
                var n = document.getElementById(t.opt.alignmentsTable);
                n.hasChildNodes();
              ...
              ;(n.style.paddingTop = "50px"),
                (l.style.backgroundColor = "#FFF"),
                (l.id = "blast-alignments-table-img")
              for (var s = 0; s < e.length; s++) {
                ...
                ;(p.alignment = e[s]),
                  (p.onclick = function () {
                    t.opt.callback
                      ? t.opt.callback(this.alignment)
                      : ((location.href = "#" + t.opt.singleAlignment),
                        w(this.alignment, t, this.alignment.hsp.length, 0))
                  }),
                ...
                ;(f.innerHTML = e[s].hsp[0].identities + "%"),
                  o.appendChild(d),
                  o.appendChild(c),
                  o.appendChild(u),
                  o.appendChild(m),
            ...
            function r(n) {
              ...
              for (e = 0; e < t.length; e++)
                (t[e].style.fontWeight = "normal"),
                  (t[e].parentElement.parentElement.style.fontWeight = "normal")
            ...
            function w(e, t, n, l) {
              for (
                var i = document.getElementById(t.opt.singleAlignment);
                i.hasChildNodes();
              ...
              var r = document.createElement("pre"),
                ...
                y = (function (e, t, n) {
                  ...
                  for (var s = 0; s < e.length; s++) {
                    var o = document.createElement("div")
                    ;(o.style.backgroundColor = A(e.charAt(s))),
                      (o.innerHTML = e.charAt(s).bold()),
                      (o.style.width = "18px"),
                ...
                v = (function (e) {
                  ...
                  for (var l = 0; l < e.length; l++) {
                    var i = document.createElement("div")
                    ;(i.style.backgroundColor = A(e.charAt(l))),
                      (i.innerHTML = e.charAt(l).bold()),
                      (i.style.width = "18px"),
                      (i.style.textAlign = "center"),
                      (i.style.display = "inline-block"),
                      t.appendChild(i)
              ...
              if (
                ...
                (u.style.width = "20%"),
                (m.innerHTML =
                  "<b>Identities:</b></br>" + e.hsp[l].identities + "%"),
                (m.style.float = "left"),
                (m.style.width = "20%"),
                (h.innerHTML =
                  "<b>Positives:</b></br>" + e.hsp[l].positives + "%"),
                (h.style.float = "left"),
                (h.style.width = "20%"),
                ...
                if (
                  ((C.className = "btn"),
                  (C.id = "blast-single-alignment-next"),
                  (C.innerHTML = "Next HSP"),
                    ...
                    document.body.appendChild(t),
                      (t.href =
                        "JPEG" == l
                          ...
                          : e.toDataURL("img/png")),
                      (t.download =
                        n.description + "-alignment." + l.toLowerCase()),
                      t.click(),
                      document.body.removeChild(e),
                      document.body.removeChild(t),
