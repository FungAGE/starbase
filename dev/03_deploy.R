...
my_dock$RUN("Rscript -e 'remotes::install_version(\"sodium\",upgrade=\"never\", version = NA)")
my_dock$RUN("Rscript -e 'remotes::install_version(\"shinyauthr\",upgrade=\"never\", version = NA)")
